...
char* ver = "v1.0";
char* fw = "v1.04.140919";
char* fwname = "TBeamLoRaESP32_vbat_OTA_Base_V1.04";
...
void setup() {
  ...
  StartWiFi();
  WiFi.softAP("TBeamLoRaClock", "password");
  Start_Time_Services();
...
{ ArduinoOTA.handle();
  ...
  if (VBAT >= 3.10) {
    ...
    display.drawString(43, 48, String((VBAT), 2) + "v");//48
    ...
    display.setFont(ArialMT_Plain_10); display.drawString(0, 28, "WiFi"); display.setFont(ArialMT_Plain_16); display.drawString(0, 38, wifiUP); //
    ...
    display.setFont(ArialMT_Plain_10); display.drawString(0, 53, Time_str); display.drawString(100, 53, DwnTime_str);
